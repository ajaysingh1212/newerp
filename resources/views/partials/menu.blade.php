            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('manual_entry_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/manual-parties*") ? "menu-open" : "" }} {{ request()->is("admin/manual-products*") ? "menu-open" : "" }} {{ request()->is("admin/manual-activations*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            @can('manual_party_access')
                                <li class="nav-item">
                                    <a href="{{ route('admin.manual-parties.index') }}" class="nav-link {{ request()->is('admin/manual-parties') || request()->is('admin/manual-parties/*') ? 'active' : '' }}">
                            ...
                            @can('manual_fitter_access')
                                <li class="nav-item">
                                    <a href="{{ route('admin.manual-fitters.index') }}" class="nav-link {{ request()->is('admin/manual-fitters') || request()->is('admin/manual-fitters/*') ? 'active' : '' }}">
                                        <i class="fa-fw nav-icon fas fa-user-hard-hat"></i>
                                        <p>Fitter</p>
                                    </a>
                                </li>
                            @endcan
                            @can('manual_product_access')
                                <li class="nav-item">
                            ...
                            @endcan
                            @can('manual_activation_access')
                                <li class="nav-item">
                                    <a href="{{ route('admin.manual-activations.index') }}" class="nav-link {{ request()->is('admin/manual-activations') || request()->is('admin/manual-activations/*') ? 'active' : '' }}">
