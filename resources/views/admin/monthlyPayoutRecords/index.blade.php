...
@can('monthly_payout_record_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'MonthlyPayoutRecord', 'route' => 'admin.monthly-payout-records.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-MonthlyPayoutRecord">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-MonthlyPayoutRecord:not(.ajaxTable)').DataTable({ buttons: dtButtons })
