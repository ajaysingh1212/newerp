...
<div class="container mt-4">
    <div class="card shadow-lg border-0 rounded-3">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0">➕ Add New Deletion Data Record</h4>
        </div>
            ...
            <form action="{{ route('admin.delete-data.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="counter_name" class="form-control" value="{{ old('counter_name') }}">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="imei_no" class="form-control" value="{{ old('imei_no') }}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-bold">VTS No</label>
                        <input type="text" name="vts_no" class="form-control" value="{{ old('vts_no') }}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-bold">Delete Date</label>
                        <input type="datetime-local" name="delete_date" class="form-control" value="{{ old('delete_date') }}">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="date_of_fitting" class="form-control" value="{{ old('date_of_fitting') }}">
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="reason_for_deletion" class="form-control" rows="3">{{ old('reason_for_deletion') }}</textarea>
                    </div>
