...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.appDownload.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.app-downloads.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('appurl') ? 'is-invalid' : '' }}" type="text" name="appurl" id="appurl" value="{{ old('appurl', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('discriptio') ? 'is-invalid' : '' }}" name="discriptio" id="discriptio">{!! old('discriptio') !!}</textarea>
