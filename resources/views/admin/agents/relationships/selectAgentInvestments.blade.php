    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-selectAgentInvestments">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.investment.fields.select_agent') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($investments as $key => $investment)
                            <tr data-entry-id="{{ $investment->id }}">
                                ...
                                <td>
                                    {{ $investment->select_agent->phone_number ?? '' }}
                                </td>
                                <td>
                                    {{ $investment->select_agent->whatsapp_number ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-selectAgentInvestments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
