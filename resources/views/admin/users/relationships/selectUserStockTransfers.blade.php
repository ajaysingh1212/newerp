    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-selectUserStockTransfers">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($stockTransfers as $key => $stockTransfer)
                            <tr data-entry-id="{{ $stockTransfer->id }}">
                                ...
                                <td>
                                    {{ $stockTransfer->select_user->email ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-selectUserStockTransfers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
