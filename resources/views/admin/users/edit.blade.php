...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            @csrf
            <div class="card px-3">
                <h4 class= "text-center mt-2 py-2 bg-1">Shop Details</h4>
            <div class="row">
            ...
            <div class="form-group col-lg-4">
                <label class="required" for="gst_number">{{ trans('cruds.user.fields.gst_number') }}</label>
                <input class="form-control {{ $errors->has('gst_number') ? 'is-invalid' : '' }}" type="text" name="gst_number" id="gst_number" value="{{ old('gst_number', $user->gst_number) }}" >
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control date {{ $errors->has('date_inc') ? 'is-invalid' : '' }}" type="text" name="date_inc" id="date_inc" value="{{ old('date_inc', $user->date_inc) }}">
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('date_joining') ? 'is-invalid' : '' }}" type="text" name="date_joining" id="date_joining" value="{{ old('date_joining', $user->date_joining) }}">
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('whatsapp_number') ? 'is-invalid' : '' }}" type="text" name="whatsapp_number" id="whatsapp_number" value="{{ old('whatsapp_number', $user->whatsapp_number) }}">
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('pin_code') ? 'is-invalid' : '' }}" type="number" name="pin_code" id="pin_code" value="{{ old('pin_code', $user->pin_code) }}" step="1">
            ...
            <div class="form-group col-lg-12">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('full_address') ? 'is-invalid' : '' }}" name="full_address" id="full_address">{!! old('full_address', $user->full_address) !!}</textarea>
            ...
            <div class="card px-3">
                <h4 class= "text-center mt-2 py-2 bg-1">Bank Details</h4>
            <div class="row">

            <div class="form-group col-lg-4">
                <label for="bank_name">{{ trans('cruds.user.fields.bank_name') }}</label>
                <input class="form-control {{ $errors->has('bank_name') ? 'is-invalid' : '' }}" type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $user->bank_name) }}">
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('branch_name') ? 'is-invalid' : '' }}" type="text" name="branch_name" id="branch_name" value="{{ old('branch_name', $user->branch_name) }}">
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('ifsc') ? 'is-invalid' : '' }}" type="text" name="ifsc" id="ifsc" value="{{ old('ifsc', $user->ifsc) }}">
                @if($errors->has('ifsc'))
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('ac_holder_name') ? 'is-invalid' : '' }}" type="text" name="ac_holder_name" id="ac_holder_name" value="{{ old('ac_holder_name', $user->ac_holder_name) }}">
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('pan_number') ? 'is-invalid' : '' }}" type="text" name="pan_number" id="pan_number" value="{{ old('pan_number', $user->pan_number) }}">
             ...
             <div class="card px-3">
                <h4 class= "text-center mt-2 py-2 bg-1">Basic Details</h4>
            <div class="row">
            <div class="form-group col-lg-4">
            ...
            <div class="form-group col-lg-4">
             ...
             <div class="card px-3">
                <h4 class= "text-center mt-2 py-2 bg-1">Attach ID Proof</h4>
            <div class="row">
            <div class="form-group col-lg-4">
