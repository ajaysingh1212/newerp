...
<div class="card">
    ...
    <div class="card-body">
        @include('watermark')
        <table class="table table-bordered table-striped table-hover ajaxTable datatable datatable-RechargeRequest">
            <thead>
                <tr>
                    <th width="10"></th>
...
<script>
    $(function () {
        ...
        let dtOverrideGlobals = {
            ...
            retrieve: true,
            aaSorting: [],
            ajax: "{{ route('admin.recharge-requests.index') }}",
            columns: [
        ...
        let table = $('.datatable-RechargeRequest').DataTable(dtOverrideGlobals);
