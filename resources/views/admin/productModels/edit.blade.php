...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.productModel.title_singular') }}
    </div>

    <div class="card-body">
        @include('watermark')
        <form method="POST" action="{{ route("admin.product-models.update", [$productModel->id]) }}" enctype="multipart/form-data" class="row">
            @method('PUT')
            @csrf
            <div class="card px-3">
                <h4 class= "text-center mt-2 py-2 bg-1"> Edit Product Model</h4>
            <div class="row">
            <div class="form-group col-md-4">
                <label class="required" for="product_model">{{ trans('cruds.productModel.fields.product_model') }}</label>
                <input class="form-control {{ $errors->has('product_model') ? 'is-invalid' : '' }}" type="text" name="product_model" id="product_model" value="{{ old('product_model', $productModel->product_model) }}" required>
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('warranty') ? 'is-invalid' : '' }}" type="text" name="warranty" id="warranty" value="{{ old('warranty', $productModel->warranty) }}" required>
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('subscription') ? 'is-invalid' : '' }}" type="text" name="subscription" id="subscription" value="{{ old('subscription', $productModel->subscription) }}" required>
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('amc') ? 'is-invalid' : '' }}" type="text" name="amc" id="amc" value="{{ old('amc', $productModel->amc) }}" required>
                @if($errors->has('amc'))
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('mrp') ? 'is-invalid' : '' }}" type="text" name="mrp" id="mrp" value="{{ old('mrp', $productModel->mrp) }}" required>
                @if($errors->has('mrp'))
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('cnf_price') ? 'is-invalid' : '' }}" type="text" name="cnf_price" id="cnf_price" value="{{ old('cnf_price', $productModel->cnf_price) }}" required>
            ...
            <div class="form-group col-md-3">
                ...
                <input class="form-control {{ $errors->has('distributor_price') ? 'is-invalid' : '' }}" type="text" name="distributor_price" id="distributor_price" value="{{ old('distributor_price', $productModel->distributor_price) }}" required>
            ...
            <div class="form-group col-md-3">
                ...
                <input class="form-control {{ $errors->has('dealer_price') ? 'is-invalid' : '' }}" type="text" name="dealer_price" id="dealer_price" value="{{ old('dealer_price', $productModel->dealer_price) }}" required>
            ...
            <div class="form-group col-md-3">
                ...
                <input class="form-control {{ $errors->has('customer_price') ? 'is-invalid' : '' }}" type="text" name="customer_price" id="customer_price" value="{{ old('customer_price', $productModel->customer_price) }}" required>
            ...
            <div class="form-group col-md-3">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    ...
                    @foreach(App\Models\ProductModel::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $productModel->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
