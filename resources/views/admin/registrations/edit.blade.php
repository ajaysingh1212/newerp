    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.registrations.update", [$registration->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reg') ? 'is-invalid' : '' }}" type="text" name="reg" id="reg" value="{{ old('reg', $registration->reg) }}">
                @if($errors->has('reg'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('investor') ? 'is-invalid' : '' }}" name="investor_id" id="investor_id" required>
                    @foreach($investors as $id => $entry)
                        <option value="{{ $id }}" {{ (old('investor_id') ? old('investor_id') : $registration->investor->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('referral_code') ? 'is-invalid' : '' }}" type="text" name="referral_code" id="referral_code" value="{{ old('referral_code', $registration->referral_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aadhaar_number') ? 'is-invalid' : '' }}" type="text" name="aadhaar_number" id="aadhaar_number" value="{{ old('aadhaar_number', $registration->aadhaar_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pan_number') ? 'is-invalid' : '' }}" type="text" name="pan_number" id="pan_number" value="{{ old('pan_number', $registration->pan_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dob') ? 'is-invalid' : '' }}" type="text" name="dob" id="dob" value="{{ old('dob', $registration->dob) }}">
                @if($errors->has('dob'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('father_name') ? 'is-invalid' : '' }}" type="text" name="father_name" id="father_name" value="{{ old('father_name', $registration->father_name) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('address_line_1') ? 'is-invalid' : '' }}" name="address_line_1" id="address_line_1">{!! old('address_line_1', $registration->address_line_1) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('address_line_2') ? 'is-invalid' : '' }}" name="address_line_2" id="address_line_2">{!! old('address_line_2', $registration->address_line_2) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pincode') ? 'is-invalid' : '' }}" type="text" name="pincode" id="pincode" value="{{ old('pincode', $registration->pincode) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" type="text" name="state" id="state" value="{{ old('state', $registration->state) }}">
                @if($errors->has('state'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_account_holder_name') ? 'is-invalid' : '' }}" type="text" name="bank_account_holder_name" id="bank_account_holder_name" value="{{ old('bank_account_holder_name', $registration->bank_account_holder_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_account_number') ? 'is-invalid' : '' }}" type="text" name="bank_account_number" id="bank_account_number" value="{{ old('bank_account_number', $registration->bank_account_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ifsc_code') ? 'is-invalid' : '' }}" type="text" name="ifsc_code" id="ifsc_code" value="{{ old('ifsc_code', $registration->ifsc_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_name') ? 'is-invalid' : '' }}" type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $registration->bank_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_branch') ? 'is-invalid' : '' }}" type="text" name="bank_branch" id="bank_branch" value="{{ old('bank_branch', $registration->bank_branch) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('income_range') ? 'is-invalid' : '' }}" name="income_range" id="income_range" required>
                    ...
                    @foreach(App\Models\Registration::INCOME_RANGE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('income_range', $registration->income_range) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('occupation') ? 'is-invalid' : '' }}" name="occupation" id="occupation" required>
                    ...
                    @foreach(App\Models\Registration::OCCUPATION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('occupation', $registration->occupation) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('risk_profile') ? 'is-invalid' : '' }}" name="risk_profile" id="risk_profile">
                    ...
                    @foreach(App\Models\Registration::RISK_PROFILE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('risk_profile', $registration->risk_profile) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('investment_experience') ? 'is-invalid' : '' }}" name="investment_experience" id="investment_experience">
                    ...
                    @foreach(App\Models\Registration::INVESTMENT_EXPERIENCE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('investment_experience', $registration->investment_experience) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label>{{ trans('cruds.registration.fields.kyc_status') }}</label>
                <select class="form-control {{ $errors->has('kyc_status') ? 'is-invalid' : '' }}" name="kyc_status" id="kyc_status">
                    ...
                    @foreach(App\Models\Registration::KYC_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('kyc_status', $registration->kyc_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('kyc_status'))
                    <span class="text-danger">{{ $errors->first('kyc_status') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.registration.fields.kyc_status_helper') }}</span>
            </div>
            <div class="form-group">
                <label>{{ trans('cruds.registration.fields.account_status') }}</label>
                <select class="form-control {{ $errors->has('account_status') ? 'is-invalid' : '' }}" name="account_status" id="account_status">
                    ...
                    @foreach(App\Models\Registration::ACCOUNT_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('account_status', $registration->account_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('account_status'))
                    <span class="text-danger">{{ $errors->first('account_status') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.registration.fields.account_status_helper') }}</span>
            </div>
            <div class="form-group">
                <label>{{ trans('cruds.registration.fields.is_email_verified') }}</label>
                @foreach(App\Models\Registration::IS_EMAIL_VERIFIED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_email_verified') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_email_verified_{{ $key }}" name="is_email_verified" value="{{ $key }}" {{ old('is_email_verified', $registration->is_email_verified) === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="is_email_verified_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('is_email_verified'))
                    <span class="text-danger">{{ $errors->first('is_email_verified') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.registration.fields.is_email_verified_helper') }}</span>
            </div>
            <div class="form-group">
                <label>{{ trans('cruds.registration.fields.is_phone_verified') }}</label>
                @foreach(App\Models\Registration::IS_PHONE_VERIFIED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_phone_verified') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_phone_verified_{{ $key }}" name="is_phone_verified" value="{{ $key }}" {{ old('is_phone_verified', $registration->is_phone_verified) === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="is_phone_verified_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('is_phone_verified'))
                    <span class="text-danger">{{ $errors->first('is_phone_verified') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.registration.fields.is_phone_verified_helper') }}</span>
            </div>
            <div class="form-group">
