...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.rechargePlan.title_singular') }}
    </div>

    <div class="card-body">
        @include('watermark')
        <form method="POST" action="{{ route("admin.recharge-plans.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="card px-3">
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('amc_duration') ? 'is-invalid' : '' }}" type="text" name="amc_duration" id="amc_duration" value="{{ old('amc_duration', '') }}">
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('warranty_duration') ? 'is-invalid' : '' }}" type="text" name="warranty_duration" id="warranty_duration" value="{{ old('warranty_duration', '') }}">
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('subscription_duration') ? 'is-invalid' : '' }}" type="text" name="subscription_duration" id="subscription_duration" value="{{ old('subscription_duration', '') }}">
            ...
            <div class="form-group col-lg-12">
                ...
                <textarea class="form-control {{ $errors->has('discription') ? 'is-invalid' : '' }}" name="discription" id="discription">{{ old('discription') }}</textarea>
