...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.addCustomerVehicle.title_singular') }}
    </div>

    <div class="card-body">
         @include('watermark')
        <form method="POST" action="{{ route("admin.add-customer-vehicles.update", [$addCustomerVehicle->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="card px-3">
            ...
            <div class="form-group col-lg-3">
                ...
                <select class="form-control select2 {{ $errors->has('select_vehicle_type') ? 'is-invalid' : '' }}" name="select_vehicle_type_id" id="select_vehicle_type_id" required>
                    @foreach($select_vehicle_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('select_vehicle_type_id') ? old('select_vehicle_type_id') : $addCustomerVehicle->select_vehicle_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-lg-3">
                ...
                <input class="form-control {{ $errors->has('vehicle_number') ? 'is-invalid' : '' }}" type="text" name="vehicle_number" id="vehicle_number" value="{{ old('vehicle_number', $addCustomerVehicle->vehicle_number) }}" required>
            ...
            <div class="form-group col-lg-3">
                ...
                <input class="form-control {{ $errors->has('owners_name') ? 'is-invalid' : '' }}" type="text" name="owners_name" id="owners_name" value="{{ old('owners_name', $addCustomerVehicle->owners_name) }}" required>
            ...
            <div class="form-group col-lg-3">
                ...
                <input class="form-control date {{ $errors->has('insurance_expiry_date') ? 'is-invalid' : '' }}" type="text" name="insurance_expiry_date" id="insurance_expiry_date" value="{{ old('insurance_expiry_date', $addCustomerVehicle->insurance_expiry_date) }}" required>
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('chassis_number') ? 'is-invalid' : '' }}" type="text" name="chassis_number" id="chassis_number" value="{{ old('chassis_number', $addCustomerVehicle->chassis_number) }}">
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('vehicle_model') ? 'is-invalid' : '' }}" type="text" name="vehicle_model" id="vehicle_model" value="{{ old('vehicle_model', $addCustomerVehicle->vehicle_model) }}">
            ...
            <div class="form-group col-lg-4">
                ...
                <input class="form-control {{ $errors->has('vehicle_color') ? 'is-invalid' : '' }}" type="text" name="vehicle_color" id="vehicle_color" value="{{ old('vehicle_color', $addCustomerVehicle->vehicle_color) }}">
            ...
            <div class="form-group col-lg-12">
                ...
                <input class="form-control {{ $errors->has('owner_image') ? 'is-invalid' : '' }}" type="text" name="owner_image" id="owner_image" value="{{ old('owner_image', $addCustomerVehicle->owner_image) }}">
            ...
            <div class="form-group col-lg-12">
                <label class="required" for="insurance">{{ trans('cruds.addCustomerVehicle.fields.insurance') }}</label>
            ...
            <div class="form-group col-lg-12">
                <label class="required" for="pollution">{{ trans('cruds.addCustomerVehicle.fields.pollution') }}</label>
            ...
            <div class="form-group col-lg-12">
                <label class="required" for="registration_certificate">{{ trans('cruds.addCustomerVehicle.fields.registration_certificate') }}</label>
            ...
            <div class="form-group col-lg-3">
                <label class="required">{{ trans('cruds.addCustomerVehicle.fields.status') }}</label>
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    <option value disabled {{ old('status', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                    @foreach(App\Models\AddCustomerVehicle::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $addCustomerVehicle->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('status'))
                    <span class="text-danger">{{ $errors->first('status') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.addCustomerVehicle.fields.status_helper') }}</span>
            </div>
            </div>
            </div>
