    ...
    <div class="gps-shell">
        <div class="gps-topbar no-print">
            <div class="gps-topbar-group">
                <a href="{{ route('admin.gps-card-lookup.index') }}" class="gps-pill gps-back">&larr; Back</a>
                <span class="gps-pill">Admin Lookup</span>
...
@push('scripts')
    ...
    <script>
        ...
        document.getElementById('savePdfBtn')?.addEventListener('click', function () {
            ...
            html2pdf().set({
                margin: [8, 8, 8, 8],
                filename: 'gps-card-{{ $cardNumber }}-admin-report.pdf',
