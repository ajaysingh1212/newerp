            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="bg-green-50 p-4 rounded-lg">
                        ...
                        <input type="number" step="0.01" name="principal_amount" id="principal_amount" value="{{ old('principal_amount', $investment->principal_amount) }}" class="w-full rounded-lg border-gray-300 shadow-sm px-3 py-2 text-sm" required>
                    ...
                    <div class="bg-yellow-50 p-4 rounded-lg">
                        ...
                        <input type="text" name="secure_interest_percent" id="secure_interest_percent" value="{{ old('secure_interest_percent', $investment->secure_interest_percent) }}" class="w-full rounded-lg border-gray-300 shadow-sm px-3 py-2 text-sm">
                    ...
                    <div class="bg-yellow-50 p-4 rounded-lg">
                        ...
                        <input type="text" name="market_interest_percent" id="market_interest_percent" value="{{ old('market_interest_percent', $investment->market_interest_percent) }}" class="w-full rounded-lg border-gray-300 shadow-sm px-3 py-2 text-sm">
                    ...
                    <div class="bg-yellow-50 p-4 rounded-lg">
                        ...
                        <input type="text" name="total_interest_percent" id="total_interest_percent" value="{{ old('total_interest_percent', $investment->total_interest_percent) }}" class="w-full rounded-lg border-gray-300 shadow-sm px-3 py-2 text-sm">
